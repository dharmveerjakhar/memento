package com.example.lifecalendar.domain
...
class LifeCalendarCalculator {
    ...
    fun calculateMetrics(
        ...
        val currentWeekOfYear = calculateCurrentWeekOfYear(birthDate, referenceDate)
    ...
    fun calculateCurrentWeekOfYear(
        ...
        val totalWeeksLived = calculateWeeksLived(birthDate, referenceDate)
